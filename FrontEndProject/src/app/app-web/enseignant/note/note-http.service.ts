...
private matier: Matier;
 ...
 return this.httpClient.get<Note[]> ('http://localhost:18080/madrasati/getNoteByIdenseignant', {params: params});
  }

  getEleve(idClasse: Number) {
    const params: HttpParams = new HttpParams();
    params.set('idClasse', idClasse.toString());
    return this.httpClient.get<Eleve> ('http://localhost:18080/madrasati/getEleveByIdClasse' , {params: params});
  }
...
getClasse(idEnseignant: Number , idMatier: Number): Observable<Classe> {
  ...
  return this.httpClient.get<Classe> ('http://localhost:18080/madrasati/getClassesByIdEnseignant', { params: params} );
}
...
params = params.append('idEnseignant', idEnseignant.toString());
 return this.httpClient.get<MatierEnseignantClasse[]> ('http://localhost:18080/madrasati/getMatiereByIdEnseignant', {params: params} );
}
